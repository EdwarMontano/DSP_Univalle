...
%%%%%%%%%%%%%%%%
% Operaciones de sub y sobre muestreo sobre señales de audio
%%%%%%%%%%%%%
...
%Obtener información de archivo-audio 1
...
%Obtener información de archivo-audio 2
Informx2=audioinfo(audio2)


%1. Comparar longitudes, número de canales y frecuencia de muestreo de las
%señales de audio

%2. Ajuste de frecuencias de muestreo


%3. Selección Operación entre audios
